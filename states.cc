...
namespace KNX
{
  namespace ConnectionState
  {
    ...
    void
    State::changeState (KNX::Connection* con,
    ...
    void
    Closed::open (KNX::Connection* con, const std::string& ip)
    {
	...
	{
	  std::cerr << "Received wrong package: " << upe.what() << std::endl;
	  return;
	}
    ...
    void
    Opened::close (KNX::Connection* con)
    {
    ...
    void
    Opened::send (KNX::Connection* con)
    {
    }
